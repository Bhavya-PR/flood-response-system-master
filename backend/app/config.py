...
class Settings(BaseSettings):
    ...
    # ⚠️ Set real value in backend/.env — this default will fail intentionally
    DATABASE_URL: str = ""
    ...
    # JWT Authentication
    # ⚠️ Set real value in backend/.env — never commit real secret keys
    SECRET_KEY: str = ""
    ALGORITHM: str = "HS256"
    ...
    def ALLOWED_ORIGINS(self) -> List[str]:
        ...
        prod_origins = [
            ...
            "https://qlkamyagzqgoggbhvogo.supabase.co",  # Supabase dashboard
        ]
    ...
    def DATABASE_URL_WITH_PARAMS(self) -> str:
        ...
        # Add SSL and connection parameters for Supabase (handles both direct and pooler URLs)
        if "supabase.co" in base_url or "supabase.com" in base_url:
            if "?" not in base_url:
                base_url += "?"
            else:
                base_url += "&"
    ...
    def DATABASE_CONFIG(self) -> dict:
        ...
        # Add SSL configuration for Supabase (handles both direct and pooler URLs)
    ...
    def validate_database_connection(self) -> bool:
        ...
        try:
            ...
            if not self.DATABASE_URL.startswith("postgresql://"):
                return False
            # Just check that it has enough content to be a real URL
            return len(self.DATABASE_URL) > 30
        except Exception:
            return False
